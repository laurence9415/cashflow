<template>
  <div>
    <label class="text-4xl">CASHFLOWS FOR TODAY</label> <br />
    <label class="text-2xl">{{ totalAmount }}</label>
    <div>
    ...
    <!-- <button @click="handleAddForm">Add Form</button> -->

    <!-- <button @click="handleStoreForms">Save</button> -->
